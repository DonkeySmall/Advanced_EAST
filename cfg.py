...
num_channels = 3
# Num of Levels in Feature Extraction
feature_layers_range = range(5, 1, -1)
# feature_layers_range = range(3, 0, -1)
feature_layers_num = len(feature_layers_range)
# Tried to pixel_size = 4
# For Each Bounding Boxes, the pixel size is related to feature layer range, so for each boxes, we have 
# np.zeros((height // cfg.pixel_size, width // cfg.pixel_size, 7))
pixel_size = 2 ** feature_layers_range[-1]
# If you don't have GPU, set locked_layers as True
locked_layers = False
